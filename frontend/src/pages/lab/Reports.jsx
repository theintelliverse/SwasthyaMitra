        ...
        <main className="px-4 md:px-8 py-6 flex-grow max-w-7xl mx-auto w-full space-y-6">
          <div className="flex justify-between items-start mb-4">
            ...
            <div className="flex gap-3">
               ...
               <button onClick={fetchReports} className="flex items-center gap-2 px-4 py-2 bg-white border border-gray-200 rounded-lg text-sm font-semibold text-gray-700 hover:bg-gray-50 shadow-sm transition-colors">
                 Refresh
               </button>
            </div>
          </div>
