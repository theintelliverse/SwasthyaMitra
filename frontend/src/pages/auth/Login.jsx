              ...
              <div className="space-y-2 group/field">
                ...
                <div className={`relative transition-all duration-300 transform ${focusedField === 'password' ? 'scale-[1.02]' : ''}`}>
                  ...
                  <input
                    ...
                    className={`w-full pl-12 pr-14 py-3 bg-parchment/50 border rounded-2xl focus:outline-none focus:ring-4 transition-all font-medium text-teak ${loginError?.type === 'credentials' ? 'border-red-300 focus:border-red-400 focus:ring-red-500/5' : 'border-sandstone focus:border-marigold focus:ring-marigold/5'
                      }`}
                  ...
                  <button
                    ...
                    className="absolute right-5 top-1/2 -translate-y-1/2 text-khaki/40 hover:text-marigold transition-colors"
                  >
