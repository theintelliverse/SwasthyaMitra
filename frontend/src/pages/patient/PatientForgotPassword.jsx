            ...
            <div className="w-full max-w-xl bg-white rounded-[3rem] shadow-2xl border border-slate-100 overflow-hidden flex flex-col md:flex-row">
                ...
                <div className="w-full md:w-5/12 bg-slate-900 p-10 text-white flex flex-col justify-between relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                        ...
                        <h2 className="text-3xl font-bold tracking-tight leading-tight mb-4">Account <br />Recovery <span className="text-teal-500">.</span></h2>
                        <p className="text-slate-400 text-sm font-normal leading-relaxed">Securely reset your master password using OTP verification.</p>
                    </div>
                ...
                <div className="w-full md:w-7/12 p-10 md:p-12">
                    ...
                    {step === 1 && (
                        <form onSubmit={handleSendOTP} className="space-y-8 animate-in fade-in slide-in-from-right-4 duration-500">
                            <div className="space-y-2">
                                <label className="text-xs font-medium text-slate-500 ml-2">Linked Mobile Number</label>
                    ...
                    {step === 3 && (
                        <form onSubmit={handleResetPassword} className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-500">
                            <div className="space-y-2">
                                <label className="text-xs font-medium text-slate-500 ml-2">New Master Password</label>
                                <div className="relative group">
                    ...
                    <div className="mt-12 text-center">
                        <button onClick={() => navigate('/patient/login')} className="text-sm text-slate-500 font-normal hover:text-teal-600 flex items-center justify-center gap-2 mx-auto">
