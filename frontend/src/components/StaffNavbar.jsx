        ...
        <div className="flex items-center gap-3 md:gap-4 flex-1 min-w-0">
          ...
          <div className="min-w-0">
            ...
            <div className="flex items-center gap-2 mt-1">
              ...
              <p className="text-[14px] md:text-[14px] font-black uppercase tracking-widest text-khaki truncate">{clinicName} • Live</p>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3 md:gap-6">
          ...
          <div className="hidden md:flex items-center gap-2 border-r border-sandstone/20 pr-4 md:pr-6">
            ...
            >
              ...
              <span className="invisible group-hover:visible absolute bottom-full right-0 mb-2 bg-teak text-white text-[14px] px-2 py-1 rounded whitespace-nowrap">Notifications</span>
            </button>
            <button
            ...
            >
              <Settings size={18} />
              <span className="invisible group-hover:visible absolute bottom-full right-0 mb-2 bg-teak text-white text-[14px] px-2 py-1 rounded whitespace-nowrap">Settings</span>
            </button>
          </div>
          ...
          <div className="hidden sm:flex items-center gap-3 md:gap-4">
            <div className="text-right">
              <p className="text-[14px] font-black uppercase text-teak truncate">{userName}</p>
              <p className="text-[14px] font-bold text-khaki uppercase tracking-tighter">Authorized Access</p>
            </div>
          </div>
          ...
          <button
            ...
            className="hidden md:flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-parchment to-parchment/80 border border-sandstone rounded-xl text-[14px] font-black uppercase tracking-widest text-khaki hover:bg-red-50 hover:text-red-600 hover:border-red-100 transition-all active:scale-95 group"
          >
          ...
          <div className="fixed top-16 right-0 left-4 bg-white border border-sandstone rounded-xl shadow-lg z-20 md:hidden animate-in fade-in slide-in-from-top-2 duration-200">
            <div className="p-4 space-y-3">
              ...
              <div className="flex items-center gap-3 pb-3 border-b border-sandstone/20">
                <div className="w-10 h-10 bg-gradient-to-br from-teak to-orange-700 rounded-lg flex items-center justify-center text-white text-[14px] font-black">
                  {userName.charAt(0).toUpperCase()}
                </div>
                <div>
                  <p className="text-[14px] font-bold text-teak uppercase">{userName}</p>
                  <p className="text-[14px] text-khaki capitalize">{roleName}</p>
                </div>
              </div>
