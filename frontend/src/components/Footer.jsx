      ...
      <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="space-y-5">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <span className="text-[9px] font-black uppercase tracking-widest text-[#D4E4DF]/40 block mt-0.5">Healthcare OS for Bharat</span>
              </div>
            </div>
            <p className="text-xs text-[#D4E4DF]/70 font-medium leading-relaxed max-w-sm">
              Empowering clinics with real-time patient queue management, cloud prescriptions, 
              and patient digital locker repositories to deliver care without waiting.
            </p>
          </div>

          {/* Column 2: Digital Patient Portals */}
          <div className="space-y-4 col-span-1 md:pl-12">
            <h4 className="text-[10px] font-black uppercase text-[#2D9B6F] tracking-widest">
              Patient Services
            </h4>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3 px-4 py-3 bg-teal-950/40 rounded-2xl border border-teal-800/30">
                ...
                <div>
                  <p className="text-[10px] font-black uppercase text-white tracking-wider">HIPAA Secure Vault</p>
                  <p className="text-[8px] font-bold text-[#D4E4DF]/60 uppercase">OTP-Protected Healthcare Records</p>
                </div>
              </div>
              ...
              <div className="flex items-center justify-between px-4 py-3 bg-teal-950/40 rounded-2xl border border-teal-800/30">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-[10px] font-black uppercase tracking-wider">Real-time Node</span>
                </div>
        ...
        <div className="pt-8 flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="flex flex-col items-center md:items-start gap-1">
            <p className="text-[10px] font-bold uppercase tracking-[0.2em] text-[#D4E4DF]/50">
              © 2026 Appointory. All rights reserved.
            </p>
            <p className="text-[9px] font-black uppercase tracking-widest text-[#D4E4DF]/30 flex items-center gap-1">
              Developed by <span className="text-[#2D9B6F] font-black">The Intelliverse</span>
            </p>
          </div>

          {/* Legal Links */}
          <div className="flex gap-8 text-[10px] font-black uppercase tracking-widest text-[#D4E4DF]/70">
